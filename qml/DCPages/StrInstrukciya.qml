...
изменить вручную.</p>
<p><img src = \"/images/DCButtons/24x24/DCKnopkaVidelit_2.png\"> - Перемещение мышкой pdf документа.</p>
<p><img src = \"/images/DCButtons/24x24/DCKnopkaVidelit_1.png\"> - Выделение текста в pdf документе.</p>
</ol>
                    </body>
                </html>"
            );
