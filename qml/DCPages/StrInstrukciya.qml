...
<p>Функционал:</p>
<p>(&lt;) Вернуться в Меню программы Ментор.</p>
<p>(i) Инструкция по анимации.</p>
<p>(+) Добавить текст, который будет увеличиваться с логотипом.</p>
<p>Горячие клавиши:</p>
<p>Escape - Отмена действия.</p>
<p>Пробел - Старт анимации.</p>
<p>... Меню анимации.</p>
<p>[Добавить] Добавить текс, который будет увеличиваться с логотипом.</p>
<p>[Старт] Старт анимации.</p>
<p>[Без рамки] Без рамки.</p>
<p>[Рамка 16:9] Показ рамки для съёмки видео в пропорции экрана 16:9.</p>
<p>[Закрыть] Закрыть приложение Ментор.</p>
                                </body>
                            </html>");
                    }
					else{
						if(strInstrukciya === "hotkey"){
							txdZona.text = qsTr("
								<html>
									<body>
    <p><b>Список. Элементы. Данные:</b></p>
    <p>[Escape] - Отмена действия.</p>
    <p>[F1] - Описание.</p>
    <p>[Ctrl N] или [Shift I] - Создать новый элемент.</p>
    <p>[Ctrl S] или [Enter] - Сохранить изменения в элементе.</p>
    <p>[Стрелка вверх] или [K] - Листание списка вверх.</p>
    <p>[Стрелка вниз] или [J] - Листание списка вниз.</p>
    <p><b>Просмотщик документов:</b></p>
	<p>[PgUp] - Страница вверх.</p>
	<p>[PgDn] - Страница вниз.</p>
	<p>[Ctrl +] - Масштаб увеличить.</p>
	<p>[Ctrl -] - Масштаб уменьшить.</p>
	<p>[Ctrl F] - Включить режим поиска.</p>
    <p>[Ctrl S] или [Enter] - Начать поиск.</p>
    <p>[Escape] - Отмена поиска.</p>
    ...
    <p><b>Описание:</b></p>
    <p>[Ctrl F] - Навигатор.</p>
    <p>[Ctrl N] или [Shift I] - Режим редактирования текста.</p>
    <p>[Ctrl S] - Сохранить изменения текста.</p>
    <p>[Стрелка вверх] или [K] - Листание текста вверх.</p>
    <p>[Стрелка вниз] или [J] - Листание текста вниз.</p>
	<p><b>Анимация:</b></p>
    <p>[F1] - Инструкция.</p>
    <p>[Ctrl N] или [Shift I] - Режим добавления текста анимации.</p>
    <p>[Ctrl S] или [Enter] - Сохранить текст анимации.</p>
    <p>[Пробел] - Старт анимации.</p>
    <p>[Escape] - Отмена действия.</p>
                                    </body>
								</html>");
