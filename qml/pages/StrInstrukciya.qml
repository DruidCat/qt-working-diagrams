...
Item {
    ...
    Component.onCompleted: {//Когда страница отрисовалась, то...
        if (strInstrukciya === "obavtore"){//Если это анотация Об Авторе приложения, то...
            ...
            txdZona.text = "Здравствуйте, данную программу написал в свободное от работы время Синебрюхов \
...
Адрес электройнной почты автора: druidcat@yandex.ru";
            ...
            if(strInstrukciya === "fdinstrukciya"){//Если это Инструкция Проводника, то...
                //Любые пробелы и табы в тексте отобразятся в приложении.
                txdZona.text = "В Проводнике выбирайте PDF документы, которые хотите добавить в приложение. \
...
док.pdf\tДокумент возможно добавить в приложение.";
            }
        }
    }
}
