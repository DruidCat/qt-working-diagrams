...
///////////////////////////////////////////
	QString strTitul = "Высота 239";
	QString strOpisanie = "Описание Высоты 239.";
...
/////////////////////////////////////////////////////////
	...
	if(strTitul.isEmpty())//Если Титул пустой, то...
		qdebug("DataTitul::polTitul(): Пустое имя титула.");
...
/////////////////////////////////////////////////////////
	...
	if(strOpisanie.isEmpty())//Если описание Титула пустое, то...
		qdebug("DataTitul::polOpisanie(): Пустое описание титула.");
